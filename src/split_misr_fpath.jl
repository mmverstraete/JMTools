...
# Purpose(s):
* Split the full filesystem path name `misr_fpath` of a directory containing MISR data file(s) and return the MISR root directory, the MISR Path number and the MISR product acronym.
