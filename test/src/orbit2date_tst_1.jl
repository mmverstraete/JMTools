...
# Purpose(s):
* Generate the output of `orbit2date.jl` for testing purposes. Test 1: Without keyword argument.
...
julia> include(JMTools_test * "src/orbit2date_tst_1.jl")
orbit2date_tst_1

julia> orbit_date, orbit_date_string = orbit2date_tst_1();
...
```
"""
function orbit2date_tst_1(
    )::Tuple{Dates.Date, AbstractString}

    orbit_date, orbit_date_string = orbit2date(68050)
