...
# Purpose(s):
* Generate the output of `orbit2date.jl` for testing purposes. Test 4: MISRHR format.
...
julia> include(JMTools_test * "src/orbit2date_tst_4.jl")
orbit2date_tst_4

julia> orbit_date, orbit_date_string = orbit2date_tst_4();

julia> @test orbit_date == Date("2012-10-03")
Test Passed

julia> @test orbit_date_string == "20121003"
Test Passed
```
"""
function orbit2date_tst_4(
    )::Tuple{Dates.Date, AbstractString}

    orbit_date, orbit_date_string = orbit2date(68050; fmt = "MISRHR")
