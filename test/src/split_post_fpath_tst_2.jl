...
# Purpose(s):
Generate the output of `split_post_fpath.jl` for testing purposes. Test 2: For a moderately complex path.
...
julia> include(JMTools_test * "src/split_post_fpath_tst_2.jl")
split_post_fpath_tst_2

julia> mroot_post, user, project, location, call_f, prdct, ftype = split_post_fpath_tst_2();
...
```
"""
function split_post_fpath_tst_2(
